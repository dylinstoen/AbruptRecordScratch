...
namespace _Project.Scripts.Gameplay {
    public class GameManager : MonoBehaviour {
        ...
        public void Initialize(IDeathEvents deathEvents, IDeathScreen deathScreen, IInputModeService inputMode, IDeathUIIInputEvent deathUiiInputEvent, ILevelController levelController) {
            Unsubscribe();
